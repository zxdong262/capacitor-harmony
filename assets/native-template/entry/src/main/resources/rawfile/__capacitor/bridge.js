...
(function (win) {
  ...
  // NOTE: the array literal below is replaced with a JSON literal by the
  // native LocalAssetServer before this file is handed to the WebView.
  // (Keep this comment free of the placeholder token so String.replace
  // hits the code below, not the comment.)
  cap.PluginHeaders = __CAPACITOR_PLUGIN_HEADERS__;
